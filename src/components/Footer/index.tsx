  ...
  return (
    <footer className="flex bg-neutral-800 text-neutral-50">
      <div className="container mx-auto py-12 gap-5 flex flex-col">
        <div className="grid grid-cols-2 gap-8 lg:flex-row justify-between items-center">
          ...
          <div className="flex gap-12 justify-between">
            <ul className="flex flex-col gap-4">
              <li className="flex gap-2 items-center">
                <div className="w-fit h-fit cursor-pointer border border-neutral-50 rounded-full text-base p-2 hover:bg-neutral-50 hover:text-neutral-800 transition-colors">
                  <FaLocationDot />
                </div>
            ...
            <ul className="flex flex-col gap-3">
              {socialMedia.map((social, index) => (
                ...
                >
                  <li className="w-fit h-fit cursor-pointer border border-neutral-50 rounded-full text-base p-2 hover:bg-neutral-50 hover:text-neutral-800 transition-colors">
                    <social.icon />
                  </li>
                </Link>
              ))}
        ...
        <div className="flex flex-col items-center gap-4 md:flex-row justify-between text-center">
          <p>
